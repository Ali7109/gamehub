        ...
        className=" h-full max-h-72 w-full rounded-xl bg-dash-backdrop bg-center bg-cover">
            <div className="bg-black/60  flex flex-col md:flex-row h-full w-full">
              ...
              transition={{ease: "easeInOut", duration: 1, delay: 3}}
               className="flex-1 flex flex-col md:justify-center space-y-10 w-2/3 md:w-2/3 p-5 md:p-10 text-white font-sans hover:antialiased">
              ...
              className="flex-2 relative md:w-7/12">
